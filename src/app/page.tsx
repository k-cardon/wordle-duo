...
const Home: React.FC = () => {
    ...
    const getFeedback = (guess: string) => {
        const feedback = Array(5).fill('absent'); // Start with all letters as absent
        ...
        guessArray.forEach((letter, index) => {
            if (letter === answerArray[index]) {
                ...
                answerArray[index] = ''; // Mark this position as checked
            }
        });
        ...
        guessArray.forEach((letter, index) => {
            if (feedback[index] !== 'correct' && answerArray.includes(letter)) {
                ...
                answerArray[answerArray.indexOf(letter)] = ''; // Mark this position as checked
            }
        });
    ...
    const handleGuessSubmit = (e: FormEvent) => {
        ...
        const validWord = words.includes(upperGuess) || upperGuess === userAddedWord;
        ...
        if (validWord) {
            ...
            console.log(feedback); // For debugging purposes, can be removed later
        } else {
            setMessage('Please enter a valid 5-letter word.');
        }
                                        ...
                                        {attempt.split('').map((letter, letterIndex) => (
                                            <span
                                                ...
                                                style={{
                                                    ...
                                                    lineHeight: '30px',
                                                    margin: '0 2px',
                                                    backgroundColor: feedback[letterIndex] === 'correct' ? 'green' : feedback[letterIndex] === 'present' ? 'yellow' : 'grey',
                                                    color: 'white',
                                                    textAlign: 'center',
                                                    borderRadius: '5px'
                                                }}
